...
{
    /// <summary>
    /// Класс для создания приза, который увеличивает мощность силы выстрела
    /// </summary>
    /// <seealso cref="GameLibrary.Factory.PrizeFactory" />
    public class BulletPowerPrizeFactory : PrizeFactory
    {
        /// <summary>
        /// Создание приза, который увеличивает мощность силы выстрела
        /// </summary>
        ...
        public override GameObject CreatePrize(Vector2 position)
        {
            ...
            gameObject.SetComponent(new TexturesBox(Content.Load("MazeElements/Prize/bullet_power.png")));
            ...
            speedPrize.Initializer(new PowerDecorator(new BasicCharacteristic()), 5f);
